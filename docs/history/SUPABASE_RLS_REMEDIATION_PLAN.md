...
`SUPABASE_*_RESULT.md` nesta pasta. Reaudite o estado live antes de reutilizar
qualquer SQL ou sequência deste documento. Caminhos `docs/...` no corpo abaixo
são anteriores à mudança para `docs/history/`.
