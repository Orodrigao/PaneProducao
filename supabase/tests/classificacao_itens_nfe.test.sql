...
-- Campo ausente vale o mesmo que "não conferido". Sem este caso, quem chama a
-- função por fora da tela desliga a trava só omitindo a chave, e a tela nunca
-- omite, então o buraco não apareceria em teste nenhum.
select throws_ok(
  $$select public.create_xml_payable(
    '96000000-0000-4000-8000-000000000004'::uuid, '35260900000000000000550010000000041000000041',
    '96000000-0000-4000-8000-0000000000f1'::uuid, '4', '1', current_date, 'boleto', 100, '',
    '[{"line_number":1,"supplier_product_code":"CHOC-2","source_description":"CHIPS AO LEITE CAIXA",
       "source_unit":"CX","source_quantity":1,"product_id":"96000000-0000-4000-8000-0000000000d1",
       "conversion_basis":"package","conversion_factor":1,"usable_quantity":1,
       "line_total":100,"unit_price":100,"discount_value":0,
       "remember_conversion":false,"mapping_status":"mapeado"}]'::jsonb,
    '[{"installment_number":1,"due_date":"2026-09-30","amount":100}]'::jsonb)$$,
  '22023', 'Confira quanto vem na embalagem: a NF-e cobra em CX e a receita usa kg.',
  'importação sem o campo de confirmação é recusada, e não tratada como confirmada');
