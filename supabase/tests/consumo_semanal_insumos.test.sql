...
select is((select purchases_counted from public.inventory_consumption_periods('jc')),1075.00::numeric,
  'compras de insumos contados: farinha 700 + 175 e manteiga 200 (a nota do sabado inicial, a cancelada e a posterior ficam fora)');
...
select is((select purchases_total from public.inventory_consumption_periods('jc')),1210.00::numeric,
...
select is((select count(*)::int from resultado),6,
...
select is((select count(*)::int from public.inventory_consumption_items('jc','96100000-0000-4000-8000-0000000000a2')),6,
