...
values
  ...
  ('d2300000-0000-4000-8000-000000000051', '[TESTE] Financeiro sem tabela de preço', 'financeiro', 'jc', true, '["/produtos"]');
...
select lives_ok($$select set_config('teste.duplicate_product_id', public.duplicate_product_complete(
  ...
  'admin com rotas de produtos e tabelas de preço duplica o cadastro completo');
...
select throws_ok($$select public.duplicate_product_complete('d2300000-0000-4000-8000-000000000010', '[TESTE] Tentativa sem tabela de preço')$$,
  '42501', 'Sem permissão para duplicar produtos.', 'financeiro sem tabela de preço não duplica preços');
reset role;
