...
export const DEFAULT_ROUTES_BY_ROLE: Record<Role, string[]> = {
  admin:      ['/', '/sobras', '/romaneio', '/estoque-congelado', '/estoque-paes', '/compras', '/estoque', '/produtos', '/clientes', '/tabelas-preco', '/pedidos-pj', '/admin/usuarios', '/relatorios', '/relatorios/sobras-descartes'],
  ...
  romaneio:   ['/romaneio'],
  financeiro: ['/', '/sobras', '/compras', '/estoque-congelado', '/estoque', '/romaneio', '/estoque-paes', '/clientes', '/tabelas-preco', '/pedidos-pj'],
